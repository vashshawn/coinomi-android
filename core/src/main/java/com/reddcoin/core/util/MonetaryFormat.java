package com.reddcoin.core.util;
...
import com.reddcoin.core.coins.FiatValue;
...
//    }
    ...
    /**
     * Parse a human readable fiat value to a {@link com.reddcoin.core.coins.Value} instance.
     *
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
